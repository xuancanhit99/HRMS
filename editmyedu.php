            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="user" method="post" action="">
                        <?php
                        $cid = $_SESSION['uid'];
                        $ret = mysqli_query($conn, "select * from empedu where EmpID='$cid'");
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 mb-3">
                                    <input type="text" class="form-control form-control-user" id="pigra" name="pigra"
                                           aria-describedby="emailHelp" required="true"
                                           value="<?php echo $row['Percentage2']; ?>">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 mb-3">
                                    <input type="text" class="form-control form-control-user" id="pissc" name="pissc"
                                           aria-describedby="emailHelp" required="true"
                                           value="<?php echo $row['Percentage3']; ?>">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 mb-3">
                                    <input type="text" class="form-control form-control-user" id="yophsc" name="yophsc"
                                           aria-describedby="emailHelp" required="true"
                                           value="<?php echo $row['YearPassing4']; ?>"></div>
                            </div>

                            <div class="row">
                                <div class="col-4 mb-3">Percentage 4</div>
                                <div class="col-8 mb-3">
                                    <input type="text" class="form-control form-control-user" id="pihsc" name="pihsc"
                                           aria-describedby="emailHelp" required="true"
                                           value="<?php echo $row['Percentage4']; ?>">
                                </div>
                            </div>
                        <?php } ?>
